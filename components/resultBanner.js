...
export default function ResultBanner() {
  return (
    <div
      className="bg-black text-light h-screen lg:bg-right bg-center lg:bg-contain bg-cover bg-no-repeat"
      ...
      <div className="flex flex-col justify-center items-center h-screen">
        <div className="flex flex-col text-center lg:pt-14 pt-8">
          <div className="flex flex-col space-y-4">
            ...
            <p className="font-roboto font-bold text-5xl lg:text-7xl">
              Results
            </p>
          </div>
        </div>
