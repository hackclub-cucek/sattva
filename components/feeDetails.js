                                    ...
                                    <Disclosure.Panel className="flex flex-col space-y-6">
                                        <div className='flex lg:flex-col sm:flex-row flex-col sm:flex-wrap justify-between gap-6'>
                                            <div className='flex flex-col space-y-2'>
                                                <h2 className='font-roboto font-semibold text-xl'>Dr.Shiny Paul</h2>
                                                <p className='font-roboto font-normal text-base'>+919496721408</p>
                                            </div>
                                            <div className='flex flex-col space-y-2'>
                                                <h2 className='font-roboto font-semibold text-xl'>Anilkumar K K</h2>
                                                <p className='font-roboto font-normal text-base'>+919447058981</p>
                                            </div>
                                            <div className='flex flex-col space-y-2'>
                                                <h2 className='font-roboto font-semibold text-xl'>Sreelekshmi H</h2>
                                                <p className='font-roboto font-normal text-base'>+918281381871</p>
                                            </div>
                                            <div className='flex flex-col space-y-2'>
                                                <h2 className='font-roboto font-semibold text-xl'>Yadhu G</h2>
                                                <p className='font-roboto font-normal text-base'>+919061200033</p>
                                            </div>
                                        </div>
                                        <a href='./doc/appeal_form_SATTVA.docx' className='flex space-x-[10px] font-roboto font-semibold items-center opacity-80 hover:opacity-100 cursor-pointer'>
