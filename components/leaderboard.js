    ...
    <div className='flex flex-col lg:flex-row justify-between bg-black text-white lg:pt-20 pt-32 lg:px-24 px-4'>
      <div className='lg:max-w-xs w-full lg:pr-4 pr-0 pb-6 lg:pb-0'>
        <div className='flex flex-col space-y-6'>
          ...
          <a href='/results' className='flex justify-between font-roboto font-semibold items-center rounded-lg border-2 border-white border-opacity-50 px-5 py-[18px] opacity-80 hover:opacity-100 cursor-pointer'>
